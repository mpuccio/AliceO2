...
| Gate 4: combined disconnected tracking | Ready for planning | Gate 3 no longer blocks a combined ITS+MFT TimeFrame/topology design. It remains a separately scoped implementation and validation gate. |
