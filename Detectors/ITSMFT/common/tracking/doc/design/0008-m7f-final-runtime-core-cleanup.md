...
| Narrow adapter-owned compatibility | `include/ITSMFTTracking/TrackingConfigParam.h`, `ITSSurfaceSpec.h`, `MFTSurfaceSpec.h`, `StaticDetectorCatalogs.h`, `NominalSurfaceMaterialDefaults.h` | ITS/MFT application constants and static descriptor tables. They select descriptors, not generic traversal behavior. |
