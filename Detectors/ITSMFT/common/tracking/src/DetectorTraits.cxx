...
bool refitSeedITS(const TrackSeed<NLayers>& seed,
                                         ...
                                         const o2::base::PropagatorImpl<float>* propagator)
{
  if constexpr (DetId == o2::detectors::DetID::MFT) {
    ...
    return refitSeedITS(seed, track, params, bz, tfInfos, unsortedClusters, propagator);
  }
}
...
template <int NLayers>
bool DetectorTraits<NLayers>::validateMFTCellClusters(const o2::its::Cluster& c0, const o2::its::Cluster& c1, const o2::its::Cluster& c2, float r2Cut)
{
  if constexpr (DetId == o2::detectors::DetID::MFT) {
    return detail::mftDistanceToSeedSquared(c0, c2, c1) < r2Cut &&
           detail::mftDistanceToSeedSquared(c0, c1, c2) < r2Cut &&
           detail::mftDistanceToSeedSquared(c1, c2, c0) < r2Cut;
  } else {
    return false;
  }
}
