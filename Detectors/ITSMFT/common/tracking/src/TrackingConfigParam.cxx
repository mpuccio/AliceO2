...
// ITS production tracking uses o2::its::TrackerParamConfig from O2::ITStracking.
static auto& sMFTCATrackerParam = TrackerParamConfig<o2::detectors::DetID::MFT>::Instance();
} // namespace o2::itsmft

// Register the dedicated ITS common-CA and combined-workflow configurations.
// This does not instantiate or rename TrackerParamConfig<DetID::ITS>.
