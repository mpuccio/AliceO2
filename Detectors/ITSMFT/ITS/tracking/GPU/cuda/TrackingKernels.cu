...
template void countCellNeighboursHandler<11>(CellSeed<11>** cellsLayersDevice,
                                             int* neighboursLUT,
                                             int** cellsLUTs,
                                             gpuPair<int, int>* cellNeighbours,
                                             int* neighboursIndexTable,
...
template void computeCellNeighboursHandler(CellSeed<11>** cellsLayersDevice,
                                           int* neighboursLUT,
                                           int** cellsLUTs,
                                           gpuPair<int, int>* cellNeighbours,
                                           int* neighboursIndexTable,
...
template void processNeighboursHandler<11>(const int startLayer,
                                           const int startLevel,
                                           CellSeed<11>** allCellSeeds,
                                           CellSeed<11>* currentCellSeeds,
                                           std::array<int, 9>& nCells,
                                           const unsigned char** usedClusters,
                                           std::array<int*, 9>& neighbours,
                                           gsl::span<int*> neighboursDeviceLUTs,
                                           const TrackingFrameInfo** foundTrackingFrameInfo,
                                           bounded_vector<CellSeed<11>>& seedsHost,
                                           const float bz,
                                           const float maxChi2ClusterAttachment,
                                           const float maxChi2NDF,
                                           const o2::base::Propagator* propagator,
...
template void countTrackSeedHandler(CellSeed<11>* trackSeeds,
                                    const TrackingFrameInfo** foundTrackingFrameInfo,
                                    const Cluster** unsortedClusters,
                                    int* seedLUT,
                                    const std::vector<float>& layerRadiiHost,
...
template void computeTrackSeedHandler(CellSeed<11>* trackSeeds,
                                      const TrackingFrameInfo** foundTrackingFrameInfo,
                                      const Cluster** unsortedClusters,
                                      o2::its::TrackITSExt* tracks,
                                      const int* seedLUT,
