...
class Tracker
{
 ...
 public:
  ...
  std::vector<MCCompLabel>& getTrackLabels(int rof);
  bool isMatLUT();
 ...
 private:
  ...
  std::vector<std::vector<MCCompLabel>> mTrackLabels;
...
inline std::vector<MCCompLabel>& Tracker::getTrackLabels(int rofs)
{
