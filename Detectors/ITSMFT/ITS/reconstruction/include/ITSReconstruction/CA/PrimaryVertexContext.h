...
class PrimaryVertexContext
    final
    {
      public:
        ...
        void initTracksMClabels();
        void setTrackMClabel(int iTrack, int label);
    ...
    inline void PrimaryVertexContext::initTracksMClabels() {
      mLabels.resize(mTracks.size(),-1);
    }

    inline void PrimaryVertexContext::setTrackMClabel(int iTrack, int label) {
      mLabels[iTrack] = label;
    }
