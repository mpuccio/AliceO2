...
#ifndef O2_ITSMFT_ITS_RECONSTRUCTION_CA_ARRAYUTILS_H_
#define O2_ITSMFT_ITS_RECONSTRUCTION_CA_ARRAYUTILS_H_
...
{
  return fillArray<T>(initializer, std::make_index_sequence<N>{});
}
...
#endif /* O2_ITSMFT_ITS_RECONSTRUCTION_CA_ARRAYUTILS_H_ */
